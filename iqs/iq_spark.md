...
<details open><summary style="font-size:20px;color:Orange"> What is Apache Spark and what are its main components?</summary>
...
<details open><summary style="font-size:20px;color:Orange"> Explain how Apache Spark differs from _Hadoop MapReduce_.</summary>
...
<details open><summary style="font-size:20px;color:Orange"> Describe the concept of RDDs (Resilient Distributed Datasets) in Spark.</summary>
...
<details open><summary style="font-size:20px;color:Orange"> What are DataFrames in Spark and how do they compare to RDDs?</summary>
...
<details open><summary style="font-size:20px;color:Orange"> What is lazy evaluation and how does it benefit Spark computations?</summary>
...
<details open><summary style="font-size:20px;color:Orange"> How does Spark achieve fault tolerance?</summary>
...
<details open><summary style="font-size:20px;color:Orange"> What is the role of Spark Driver and Executors?</summary>
...
<details open><summary style="font-size:20px;color:Orange"> How does Spark's _DAG (Directed Acyclic Graph) Scheduler_ work?</summary>
...
<details open><summary style="font-size:20px;color:Orange"> Explain the concept of a Spark Session and its purpose.</summary>
...
<details open><summary style="font-size:20px;color:Orange"> How does Spark integrate with Hadoop components like HDFS and YARN?</summary>
...
<details open><summary style="font-size:20px;color:Orange"> Describe the various ways to run Spark applications (cluster, client, local modes).</summary>
...
<details open><summary style="font-size:20px;color:Orange"> What are Spark's data source APIs and how do you use them?</summary>
...
<details open><summary style="font-size:20px;color:Orange"> Discuss the role of accumulators and broadcast variables in Spark.</summary>
...
<details open><summary style="font-size:20px;color:Orange"> What is the significance of the Catalyst optimizer in Spark SQL?</summary>
...
<details open><summary style="font-size:20px;color:Orange"> How does Tungsten contribute to Spark's performance?</summary>
